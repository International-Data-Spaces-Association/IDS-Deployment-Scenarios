...
| [A MVDS with Eclipse Dataspace Components utilizing Intel Software Guard Extensions](Deployment-Scenarios/minimum-viable-dataspace-with EDC-utilizing-Intel-Software-Guard-Extensions.md) | [Intel Corporation](https://www.intel.de/content/www/de/de/homepage.html) and [IONOS SE](https://www.ionos.com/)      | EDC deployment based on Confidential Computing principles. This shows how Intel's Software Guard Extensions can be utilized to set up a Minimal Viable Dataspace (MVD) without fundamental changes to the code of the business logic.  | Eclipse Dataspace Components |
